...
Serial.println (" m/s \r");
 ...
 if(Calc < 10)                                                //เงือนไข ถ้าค่า Calc > 30 ให้ทำใน {}
  {
     if(abnormal < 1 )   {                                              
     LINE.notify(" No.4_Finfish3_Error ");                    // ส่งข้อความแจ้งเตือน "ระบบลมในบ่อเลี้ยงมีปัญหา" ไปยัง LINE
...
if(normal > 9 )  {                                          
     abnormal = 0 ;
     normal = 0 ;
     LINE.notify(" No.4_Finfish3_Normal ");                    // ส่งข้อความแจ้งเตือน "ระบบลมในบ่อเลี้ยงมีปัญหา" ไปยัง LINE
     delay (500);   }                                         // หน่วงเวลา 0.5 วินาที
